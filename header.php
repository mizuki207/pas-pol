...
<header class="l-header">
  <h1 class="m-site-logo">
    <a class="m-site-logo--link" href="<?php echo home_url(); ?>">
    <img class="m-site-logo--img" src="<?php echo esc_url (get_template_directory_uri() . '/assets/images/siteLogo-pc@2x.webp' ); ?>"
      alt="PAS-POL -旅のモノづくりブランド-｜TABIPPO">
    </a>
  </h1>

  <nav class="m-navigation js-navigation">
    <ul class="m-navigation--lists" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
